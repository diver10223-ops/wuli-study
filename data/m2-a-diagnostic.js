...
{id:'M2AD04',node:'M2-K04',gate:'图像斜率面积',text:'v-t图像的斜率表示？',options:['加速度','位移','位置'],answer:0},
{id:'M2AD05',node:'M2-K04',text:'v-t图像与时间轴围成的有向面积表示？',options:['位移','加速度','平均速率'],answer:0},
{id:'M2AD06',node:'M2-K05',text:'汽车刹车到停下后继续代入匀减速公式会导致？',options:['虚假的倒车结果','正确反向运动','加速度消失前速度增大'],answer:0},
{id:'M2AD07',node:'M2-K06',text:'忽略空气阻力的自由落体属于？',options:['初速度为零的匀加速运动','匀速运动','任意变速运动'],answer:0},
{id:'M2AD08',node:'M2-K07',text:'多阶段运动建模首先应？',options:['按条件变化时刻分段','全程只列一个方程','只求平均速度'],answer:0}]});
