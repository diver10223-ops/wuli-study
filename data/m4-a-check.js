  ...
  "questions": [
    {
      ...
      "review": {
        ...
        "final": "故保持匀速",
        "answerIndex": 0,
        "unique": "只有选项“故保持匀速”同时满足方程与约束；其余选项分别来自下列错误链。",
        "distractors": [
          {
            "option": "模型判断：把匀速说成不受力",
            "wrongObjectOrForces": "仍取牛顿第一定律、惯性与惯性系，但遗漏方向、力项或模型边界",
            "wrongEquation": "把正确关系“0.50 kg气垫滑块以2.0 m/s运动，水平ΣF=0=0.50a，得a=0 m/s²，故保持匀速”改成与选项2相符的错误关系",
          ...
          },
          {
            ...
            "wrongObjectOrForces": "仍取牛顿第一定律、惯性与惯性系，但遗漏方向、力项或模型边界",
            "wrongEquation": "把正确关系“0.50 kg气垫滑块以2.0 m/s运动，水平ΣF=0=0.50a，得a=0 m/s²，故保持匀速”改成与选项3相符的错误关系",
    ...
    },
    {
      ...
      "review": {
        ...
        "final": "得a=3.0 m/s²向右",
        "answerIndex": 1,
        "unique": "只有选项“得a=3.0 m/s²向右”同时满足方程与约束；其余选项分别来自下列错误链。",
        "distractors": [
          {
            "option": "计算结果：把某个拉力直接当合力",
            "wrongObjectOrForces": "仍取牛顿第二定律三性，但遗漏方向、力项或模型边界",
            "wrongEquation": "把正确关系“2.0 kg小车受右10 N、左4 N，10-4=2.0a，得a=3.0 m/s²向右”改成与选项1相符的错误关系",
          ...
          },
          {
            ...
            "wrongObjectOrForces": "仍取牛顿第二定律三性，但遗漏方向、力项或模型边界",
            "wrongEquation": "把正确关系“2.0 kg小车受右10 N、左4 N，10-4=2.0a，得a=3.0 m/s²向右”改成与选项3相符的错误关系",
    ...
    },
    {
      ...
      "review": {
        ...
        "answerIndex": 2,
        "unique": "只有选项“合力1.5 N时a=1.5/0.500=3.0 m/s²”同时满足方程与约束；其余选项分别来自下列错误链。",
        "distractors": [
          {
            "option": "计算结果：把2 kg写成2 N",
            "wrongObjectOrForces": "仍取国际单位制与量纲，但遗漏方向、力项或模型边界",
            "wrongEquation": "把正确关系“500 g=0.500 kg，合力1.5 N时a=1.5/0.500=3.0 m/s²”改成与选项1相符的错误关系",
          ...
          },
          {
            ...
            "wrongObjectOrForces": "仍取国际单位制与量纲，但遗漏方向、力项或模型边界",
            "wrongEquation": "把正确关系“500 g=0.500 kg，合力1.5 N时a=1.5/0.500=3.0 m/s²”改成与选项2相符的错误关系",
    ...
    },
    {
      ...
      "review": {
        ...
        "answerIndex": 0,
        "unique": "只有选项“8-2=2a得a=3 m/s²；静止2 s后v=6 m/s”同时满足方程与约束；其余选项分别来自下列错误链。",
        "distractors": [
          {
            "option": "模型判断：漏摩擦",
            "wrongObjectOrForces": "仍取已知受力求运动，但遗漏方向、力项或模型边界",
            "wrongEquation": "把正确关系“2.0 kg物块受8 N拉力和2 N摩擦，8-2=2a得a=3 m/s²；静止2 s后v=6 m/s”改成与选项2相符的错误关系",
          ...
          },
          {
            ...
            "wrongObjectOrForces": "仍取已知受力求运动，但遗漏方向、力项或模型边界",
            "wrongEquation": "把正确关系“2.0 kg物块受8 N拉力和2 N摩擦，8-2=2a得a=3 m/s²；静止2 s后v=6 m/s”改成与选项3相符的错误关系",
    ...
    },
    {
      ...
      "review": {
        ...
        "final": "得T=3 N",
        "answerIndex": 1,
        "unique": "只有选项“得T=3 N”同时满足方程与约束；其余选项分别来自下列错误链。",
        "distractors": [
          {
            "option": "计算结果：把速度当加速度",
            "wrongObjectOrForces": "仍取已知运动反推受力，但遗漏方向、力项或模型边界",
            "wrongEquation": "把正确关系“1.0 kg小车2 s内由2增至6 m/s，a=2 m/s²；阻力1 N时T-1=2，得T=3 N”改成与选项1相符的错误关系",
          ...
          },
          {
            ...
            "wrongObjectOrForces": "仍取已知运动反推受力，但遗漏方向、力项或模型边界",
            "wrongEquation": "把正确关系“1.0 kg小车2 s内由2增至6 m/s，a=2 m/s²；阻力1 N时T-1=2，得T=3 N”改成与选项3相符的错误关系",
    ...
    },
    {
      ...
      "review": {
        ...
        "answerIndex": 2,
        "unique": "只有选项“得N=720 N而重力仍600 N”同时满足方程与约束；其余选项分别来自下列错误链。",
        "distractors": [
          {
            "option": "计算结果：用速度方向判断超失重",
            "wrongObjectOrForces": "仍取超重失重与测力实验，但遗漏方向、力项或模型边界",
            "wrongEquation": "把正确关系“60 kg乘客向上加速2.0 m/s²，N-600=60×2，得N=720 N而重力仍600 N”改成与选项1相符的错误关系",
          ...
          },
          {
            ...
            "wrongObjectOrForces": "仍取超重失重与测力实验，但遗漏方向、力项或模型边界",
            "wrongEquation": "把正确关系“60 kg乘客向上加速2.0 m/s²，N-600=60×2，得N=720 N而重力仍600 N”改成与选项2相符的错误关系",
